...
var file_air_quality_proto_rawDesc = []byte{
	...
	0x68, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xea, 0x01, 0x0a, 0x11, 0x41, 0x69, 0x72, 0x51, 0x75, 0x61,
...
var file_air_quality_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_air_quality_proto_depIdxs = []int32{
	...
	5, // 1: air_quality_grpc.AirQuality.fetch_time:type_name -> google.protobuf.Timestamp
	...
	1, // 4: air_quality_grpc.AirQualityService.GetAirQualities:output_type -> air_quality_grpc.GetAirQualitiesResponse
	3, // 5: air_quality_grpc.AirQualityService.SaveAirQualities:output_type -> air_quality_grpc.SaveAirQualitiesResponse
